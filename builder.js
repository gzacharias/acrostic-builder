...
// TODO: **** I don't seem to have a load handler in AppDelegate, bug??
...
if (window.webkit?.messageHandlers?.save)
  document.getElementById('save-btn').addEventListener('click', () => {
    const json = JSON.stringify(get_puzzle_data(), null, 2); // pretty print
...
document.getElementById('file-input').addEventListener('change', e => {
  ...
  reader.onload = e => { load_puzzle_from_file(read_data(e.target.result)); };
